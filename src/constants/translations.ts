...
export enum Translation {
  ...
  PAGE_PATIENT_LATEST_TEST_RESULT_TITLE = 'page.patient.testresult.table.header.title',
  PAGE_PATIENT_LATEST_TEST_RESULT_TABLE_HEADER_TEST = 'page.patient.testresult.cell.header.test',
  PAGE_PATIENT_LATEST_TEST_RESULT_TABLE_HEADER_DATECOLLECTED = 'page.patient.testresult.cell.header.datecollected',
  PAGE_PATIENT_LATEST_TEST_RESULT_TABLE_HEADER_DUEDATE = 'page.patient.testresult.cell.header.duedate',
  PAGE_PATIENT_LATEST_TEST_RESULT_BUTTON = 'page.patient.testresult.button',
