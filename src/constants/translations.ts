...
export enum Translation {
  ...
  PAGE_PATIENT_RESULT_TABLE_HEADER_TITLE = 'page.patient.result.table.header.title',
  PAGE_PATIENT_RESULT_CELL_HEADER_TEST = 'page.patient.result.cell.header.test',
  PAGE_PATIENT_RESULT_CELL_HEADER_DATECOLLECTED = 'page.patient.result.cell.header.datecollected',
  PAGE_PATIENT_RESULT_CELL_HEADER_DUEDATE = 'page.patient.result.cell.header.duedate',
  ...
  MODAL_PATIENT_APPOINTMENTS_SELECT_DESCRIPTION = 'modal.appointments.select.description',
  MODAL_PATIENT_APPOINTMENTS_SELECT_SERVICE_TYPE = 'modal.appointments.select.service.type',
  MODAL_PATIENT_APPOINTMENTS_SELECT_TIME_PICKER = 'modal.appointments.select.time.picker',
  MODAL_PATIENT_APPOINTMENTS_PATIENT_NAME = 'modal.appointments.patient.name',
  MODAL_PATIENT_APPOINTMENTS_SELECT_RESOURCE = 'modal.appointments.select.resourse',
