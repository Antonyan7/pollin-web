...
export enum Translation {
  ...
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_TITLE = 'page.patient.profile.medical.background.medical.history.gynecological.history.title',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_TAKING_BIRTH_CONTROL = 'page.patient.profile.medical.background.medical.history.gynecological.history.taking.birth.control',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_OVULATION = 'page.patient.profile.medical.background.medical.history.gynecological.history.ovulation',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_ANY_PREVIOUS_PAP_TEST = 'page.patient.profile.medical.background.medical.history.gynecological.history.any.previous.pap.test',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_DATE_OF_LAST_PAP_TEST = 'page.patient.profile.medical.background.medical.history.gynecological.history.date.of.last.pap.test',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_ABNORMAL_PAP = 'page.patient.profile.medical.background.medical.history.gynecological.history.abnormal.pap',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_PROCEDURES_DUE_TO_ABNORMAL_PAP = 'page.patient.profile.medical.background.medical.history.gynecological.history.procedures.due.to.abnormal.pap',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_GYNECOLOGICAL_CONDITIONS = 'page.patient.profile.medical.background.medical.history.gynecological.history.gynecological.conditions',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_SIGNS_OF_PCOS = 'page.patient.profile.medical.background.medical.history.gynecological.history.signs.of.pcos',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_HYPERPROLACTINEMIA = 'page.patient.profile.medical.background.medical.history.gynecological.history.hyperprolactinemia',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_SIGNS_OF_POI = 'page.patient.profile.medical.background.medical.history.gynecological.history.signs.of.poi',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_BREASTFEEDING = 'page.patient.profile.medical.background.medical.history.gynecological.history.breastfeeding',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_CERVIX_TREATMENT = 'page.patient.profile.medical.background.medical.history.gynecological.history.cervix.treatment',
  PAGE_PATIENT_PROFILE_MEDICAL_BACKGROUND_MEDICAL_HISTORY_GYNECOLOGICAL_HISTORY_INTERCOURSE_PAIN = 'page.patient.profile.medical.background.medical.history.gynecological.history.intercourse.pain',
