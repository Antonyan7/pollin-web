...
export enum Translation {
  ...
  PAGE_SPECIMENS_TRACKING_TRANSPORTS_MOVE_TO_ANOTHER_TRANSPORT_MODAL_SPECIMEN_ID_LABEL = 'page.specimens.tracking.transports.move.to.another.transport.modal.specimen.id.label',
